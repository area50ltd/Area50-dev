...
export const companies = pgTable('companies', {
  ...
  notify_email_escalation: boolean('notify_email_escalation').default(true),
  notify_email_low_credits: boolean('notify_email_low_credits').default(true),
  notify_weekly_digest: boolean('notify_weekly_digest').default(false),
  low_credit_threshold: integer('low_credit_threshold').default(500),
  voice_language: varchar('voice_language', { length: 20 }).default('en-US'),
  ...
  voice_provider: varchar('voice_provider', { length: 30 }).default('openai'),
  elevenlabs_voice_id: varchar('elevenlabs_voice_id', { length: 100 }),
  cost_ai_message: integer('cost_ai_message').default(1),
  cost_human_message: integer('cost_human_message').default(3),
  cost_voice_minute: integer('cost_voice_minute').default(10),
