...
import { Bot, Headphones, Phone, Eye, EyeOff, Loader2, CheckCircle2, Github, AlertCircle } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  if (emailSent) {
    return (
      <div className="min-h-screen bg-[#070711] flex items-center justify-center p-8">
        <div className="w-full max-w-md text-center">
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-10 backdrop-blur-sm">
          ...
          <div>
            <h2 className="font-heading text-4xl font-bold text-white mb-4 leading-tight">
              ...
              <span className="bg-gradient-to-r from-violet-400 to-purple-300 bg-clip-text text-transparent">
                Support smarter from day one.
              </span>
            </h2>
            <p className="text-white/40 text-base leading-relaxed">
              Set up your AI customer care in under 5 minutes. No code required.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#070711]">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 backdrop-blur-sm shadow-2xl shadow-black/50">
            ...
            <p className="text-white/50 text-sm mb-6">Start your free Zentativ workspace today</p>
              ...
              <div>
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => { setAgreedToTerms(e.target.checked); setFieldErrors((p) => ({ ...p, terms: undefined })) }}
                    className="mt-0.5 h-4 w-4 rounded border-white/20 bg-white/5 text-violet-600 focus:ring-violet-500/30 focus:ring-2 cursor-pointer"
                  />
                ...
                {fieldErrors.terms && <p className="mt-1.5 text-xs text-red-400">{fieldErrors.terms}</p>}
              </div>

              <button type="submit" disabled={loading || ssoLoading !== null}
